...
Floating-point types can be converted between each other, as well as between floating-point types and integer types. For specific type conversion syntax and rules, refer to [Numeric Type Conversions](./integer.md#numeric-type-conversions).