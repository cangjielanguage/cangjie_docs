...
- `1.0.5` Windows 版本由原来基于 GCC 构建切换为基于 LLVM-MinGW 构建，因此，`1.0.5` 版本 Windows 平台的仓颉 SDK 【xx二进制还是SDK】与之前版本的仓颉 SDK 不保证 ABI 兼容，即 `1.0.5` 版本 Windows 平台仓颉 SDK 与之前版本 Windows 平台的运行时标准库无法混合使用。
